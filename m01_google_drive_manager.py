...
SHARED_DRIVE_FOLDER_ID = '1h9NQgOxpxk_RQiNqOAJZKGibf3kIQ3Ww'
# ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
...
def list_new_videos(service):
    ...
    if not SHARED_DRIVE_FOLDER_ID:
        print("\nエラー: 検索対象のフォルダIDが設定されていません！", file=sys.stderr)
        print("Geminiを起動します")
        print("@app.py の'SHARED_DRIVE_FOLDER_ID'を？？？？に設定してくださいと入力します", file=sys.stderr)
        return []
